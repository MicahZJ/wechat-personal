<template lang="pug">
  scroll-view#attractions-wrapper(scroll-y @scrolltolower="lowerGetData")
    div.update-box(v-if="count > 0" @click="showUpdate()")
      span.update-count {{count}}
    div.tabbar-box
    ...
    news-box(v-if="toggleNum === 0" :getTopicData="topicData")
